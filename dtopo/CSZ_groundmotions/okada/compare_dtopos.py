...
for event in events:
    ...
    fname = 'dtopofiles_instant/%s_okada_instant.dtt3' % event
    ...
    fname = '%s/compare_okada_seismic_instant_%s.png' % (plotdir,event)
    ...
    fname = '%s/transects_okada_seismic_instant_%s.png' % (plotdir,event)
    savefig(fname, bbox_inches='tight')
    print('Created ', fname)
