...
if 1:   ##New 2028 Gauge numbering, see if now compliant at Westport
    ...
    ### For Hoquiam 2024 dirt project 
    structure_name.append('HOQ')
    latitude =46.916
    structure_lat.append(latitude)
    gstart32.append(127); gend32.append(163);   
    #gauges_to_plot=gauges_to_plot + list(range(127,164))
    ## The gaugeno is 1 more than the index into the arrays from the asce file
    xlim1.append(lat[124])
    xlim2.append(lat[148])
    xticks1.append(lat[126])
