...
gauges_to_plot=[551]  #Didnt get the last one
if 0:   ##New 2028 Gauge numbering
...
if 0:  #Print report for all the gauges from gstart to gend. Thinking of each gauge  as a structure, try to find the
