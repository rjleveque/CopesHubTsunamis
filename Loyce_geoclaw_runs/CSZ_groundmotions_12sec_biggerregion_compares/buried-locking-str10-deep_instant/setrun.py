...
#------------------------------
    ...
    if 0:
        # Continential shelf Variable Region, 24" to 12"
        flagregion = FlagRegion(num_dim=2)
        flagregion.name = 'Region_Coast_46_51_24to12sec'
    ...
    if 0:
        # Continential shelf Variable Region, 24" to 12"
        flagregion = FlagRegion(num_dim=2)
        flagregion.name = 'Region_Coast_40_46_24to12sec'
        flagregion.minlevel = 3
        flagregion.maxlevel = 4
        flagregion.t1 = tmax_dtopo_region
        flagregion.t2 = 1e9
    ...
    if 1: #For 12" run around region of interest (This was my slider window).
        ##  NOTE:  Use this to compare with Yong.  He had a 15sec large rectangle
        ##         for all time from -130 to coast and south to north.
        ...
        ## for Yong comparison, use a big rectangle further out.
        gauges_region = [-130.0,-126.0,40.0,51.5]
