...
if '/projects' in rundir:
    ...
    dtopoASCEdir = root_dir + '/dtopo'                 # on Loyces laptop
...
#------------------------------
    ...
    ###### Very last test. Want to see if 15" is sufficient or not
    ...
    #topofiles.append([3, topodir + '/etopo1_-138_-122_37_55_1min_nc.asc'])
    #topodir = root_dir + '/topo/topofiles'
    #topofiles.append([3, topodir + '/etopo22_1min_-163_-122_38_63.asc'])

    # 15-second etopo22:
    #topofiles.append([3, topodir + '/etopo22_-130_-123_38_52.asc'])
    ...
    dtopo_data.dtopofiles = [[3,\
      dtopoASCEdir + '/ASCE_SIFT_dtopo_Region2.tt3']]
    ...
    # Computational domain Variable Region - 1degree to 6min to 30 sec:
    ...
    if 1:
        ...
        # Making this region 5" for all time to check if gauge values change
        # from when these gauges were in the 3,4 region above and had at most 15"
        # This rectangle goes out to the Ruled Rectangle above at the trench.
        flagregion = FlagRegion(num_dim=2)
        ...
        flagregion.t2 = 1e9
        flagregion.spatial_region_type = 1  # Rectangle
        source_region = [-125.9,-124.1,46.66,47.287]
    ...
    dx_fine = 30./3600. #for this run, monitor on level 2 and up, dx_fine is level 3 here (30")

    ##Note: Below, thinking -130 is west edge of computational domain.  We have not yet made
    ##      the computational domain align with the data topo by making -130 be a finite volume
    ##      center, by shifting the domain left and south by 1/6" when 1/3" is our finest grid.
    ##      wait for inundation runs to accomplish this.
    ...
    fg.min_level_check = 5    # Trying 5 now. level 3 is 30". If amr levels is 5, will monitor 
