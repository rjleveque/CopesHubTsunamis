...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        #clawdata.tfinal = 10.     #test run for 10 sec 
    ...
    # ABER Hospital region
    # Level 8 is 1/3 sec
    flagregion = FlagRegion(num_dim=2)
    flagregion.name = 'Region_13sec_ABERhospital'
    flagregion.minlevel = 8
    flagregion.maxlevel = 8
    flagregion.t1 = 0.
    flagregion.t2 = 1e9
    flagregion.spatial_region_type = 1  # Rectangle
    flagregion.spatial_region = [-123.873,-123.82,46.958,46.9825]
    flagregions.append(flagregion)
    ...
    gauges = []
    if 1:
        gauges.append([369, -123.83185185, 46.97898148, 0, 1e+09])
        gauges.append([511, -123.85018519, 46.97824074, 0, 1e+09])
