...
import make_fgout_SBIT    # Loyces make_fgout_SBIT
...
location = 'SBIT' # set to site location if desired to use in plots/filenames
...
def setplot(plotdata, case):
    ...
    return None  # to suppress time plots
    ...
    for ifig in nfigs:
        ...
        def fixup(current_data,ifig=ifig):
            ...
            pylab.gca().set_aspect(1./pylab.cos(46.73 * pylab.pi/180.))
            t = current_data.t
