...
import make_fgout_LaPush   # Loyces make_fgout_LaPush
...
location = 'LaPush' # set to site location if desired to use in plots/filenames
...
fig_name[2] = 'Coast'
fig_extent[2] = (-127.00,-123.80,46.75,48.75)
var_minmax[2] = (-10.,10.)
topominmax[2] = (-100., 100.)
shrink_colorbar[2] = get_cbshrink(fig_extent[2])

fig_name[3] = 'LaPush 3" to 1" Area'
fig_extent[3] = (-124.68, -124.53, 47.88, 47.95)
var_minmax[3] = (-8.,8.)
topominmax[3] = (-10.,25.)
shrink_colorbar[3] = get_cbshrink(fig_extent[3])

fig_name[4] = 'LaPush 1/3" Area'
fig_extent[4] = (-124.655,-124.565, 47.895, 47.93)
var_minmax[4] = (-8.,8.)
topominmax[4] = (-10.,25.)
shrink_colorbar[4] = get_cbshrink(fig_extent[4])

fig_name[5] = 'LaPush Downtown'
fig_extent[5] = (-124.645,-124.629,47.906,47.915)
var_minmax[5] = (-8.,8.)
topominmax[5] = (-10.,25.)
...
plt_sites = {}
#This is Gauge 3 at the Quileute Center
plt_sites[1] = ('3',  -124.63638889, 47.90962963)
...
def setplot(plotdata, case):
    ...
    for ifig in nfigs:
        ...
        def fixup(current_data,ifig=ifig):
            ...
            pylab.gca().set_aspect(1./pylab.cos(47.91 * pylab.pi/180.))
            t = current_data.t

            ### Gauge 3 is the Quileute Tribal Center
