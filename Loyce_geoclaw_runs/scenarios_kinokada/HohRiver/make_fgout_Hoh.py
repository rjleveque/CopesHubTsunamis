...
Specific to Hoh, for other sites it is necessary to change the axis
...
def make_anim(outdir, plotdir, location, event):
    ...
    ax.set_aspect(1/cos(47.74*pi/180))
    ...
    # G7 is Gauge 7 at the Chief Klia Wellness Center
    yt1 = 47.74101852; Ttitle1 = 'G7'
    ...
    def annotate_transect(axtrans):
        dxkm = 1
        dxlong = dxkm/(111.* cos(pi*47.74/180))
        axtrans.plot([-124.434,-124.434+dxlong], [-12,-12],'k')
        axtrans.text(-124.434+dxlong/2, -13, '%i km' % dxkm, \
                     ha='center',va='top')
    
        xG7 = -124.41314815; yG7= 47.74101852;
        axtrans.plot([xG7,xG7],[-20,0],'k--')
        axtrans.text(-124.413, -13, ' G7')
        axtrans.grid(True)
