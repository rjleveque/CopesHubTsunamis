...
#------------------------------
    ...
    # 1/9 arcsec topo:
    topofiles.append([3, f'{topo_dir}/HohRiver_19s_mhw.asc'])
    ...
    flagregion.t2 = 1e9
    flagregion.spatial_region_type = 1  # Rectangle
    flagregion.spatial_region = [-126.6,-124.175,47.0,48.4]
    flagregions.append(flagregion)
    ...
    gauges_region = [-125.9,-124.3,47.4,48.0]
    ...
    flagregion.t2 = 1e9
    flagregion.spatial_region_type = 1  # Rectangle
    flagregion.spatial_region = [-124.52,-124.3,47.45,47.829]
    flagregions.append(flagregion)
    ...
    flagregion.t2 = 1e9
    flagregion.spatial_region_type = 1  # Rectangle
    flagregion.spatial_region = [-124.5,-124.367, 47.725,47.767]
    flagregions.append(flagregion)

    # 3sec to 1sec regionb, encloses Ruby Beach
    # Level 7 is 1 sec
    flagregion = FlagRegion(num_dim=2)
    ...
    # Level 7 is 1 sec
    flagregion = FlagRegion(num_dim=2)
    flagregion.name = 'Region_3sec_1sec_c'
    flagregion.minlevel = 6
    flagregion.maxlevel = 7
    flagregion.t1 = 0.
    flagregion.t2 = 1e9
    ...
    # Level 8 is 1/3 sec
    flagregion = FlagRegion(num_dim=2)
    flagregion.name = 'Region_13sec_Hoh'
    flagregion.minlevel = 8
    flagregion.maxlevel = 8
    flagregion.t1 = 0.
    flagregion.t2 = 1e9
    flagregion.spatial_region_type = 1  # Rectangle
    flagregion.spatial_region = [-124.45,-124.3725,47.725,47.7525]
    flagregions.append(flagregion)

    # Ruby Beach 1/3sec region 
    # Level 8 is 1/3 sec
    flagregion = FlagRegion(num_dim=2)
    flagregion.name = 'Region_13sec_RubyBeach'
    flagregion.minlevel = 8
    flagregion.maxlevel = 8
    flagregion.t1 = 0.
    flagregion.t2 = 1e9
    ...
    # Level 8 is 1/3 sec
    flagregion = FlagRegion(num_dim=2)
    flagregion.name = 'Region_13sec_Kalaloch'
    flagregion.minlevel = 8
    flagregion.maxlevel = 8
    flagregion.t1 = 0.
    flagregion.t2 = 1e9
    ...
    gauges = []
    if 1: #Hoh centered in 1/3" cells
    ...
    if 1:
        ...
        fg.tstart_max =  clawdata.t0 + 15*60   #start monitoring max values at 15 minutes, final B will have happened
    ...
    if 1:
        ...
        fg.dx = dx_fine
        #fg.tstart_max = 0                    #start here when finding B0
        fg.tstart_max =  clawdata.t0 + 15*60   # when to start monitoring max values
        fg.tend_max = 1.e10         # when to stop monitoring max values
        fg.dt_check = 5.           # target time (sec) increment between updating
                                    # max values
                            # which levels to monitor max on
    ...
    if 1:
        ...
        fgout.nx = 836
        fgout.ny = 295
        fgout.x1 = -124.45 + one_sixth
        fgout.x2 = -124.3725 - one_sixth
