...
#dtopo_dir = os.path.join(root_dir, 'dtopo/CSZ_groundmotions/vertical_displacements_taper')
dtopo_dir = '/Users/rjl/scratch/dtopos_taper'
...
xgeoclaw_path = os.path.join(root_dir, 'geoclaw_runs/xgeoclaw_v511')
