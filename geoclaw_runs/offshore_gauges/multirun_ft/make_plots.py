...
if 0:
    ...
    events = ['buried-random-mur13-deep-nosub-homogeneous-halfspace-noQ_instant',
        'buried-random-mur13-deep_nosub_shiftdoubling_instant',
        'buried-random-mur13-deep_updiptaper_hetero_instant',
        'buried-random-mur13-deep_updiptaper_homogen_instant']
    #events = events[:1]
