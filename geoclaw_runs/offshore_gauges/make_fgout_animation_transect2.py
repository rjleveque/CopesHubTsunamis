...
outdir = '_output_30sec'
# Output files:
name = 'animation_with_transect_30sec'
...
y0 = 47.  # latitude for aspect ratio
...
# inset axes....
axins = ax.inset_axes([1.5,0.3,2.2,1.0])
...
axins.set_title("Offshore Grays Harbor")
...
axtrans = axes([.45,.15,.45,.3])
axtrans.set_title('Transect at y = %.2f' % y2trans)
