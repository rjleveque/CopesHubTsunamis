...
if '/projects' in rundir:
    ...
    topodir = root_dir + '/topo/topofiles'             # on laptop
    dtopodir = root_dir + '/dtopo/CSZ_groundmotions/dtopofiles'   # on laptop
...
#------------------------------
    ...
    clawdata.restart_file = os.path.abspath('_output/fort.chkbbbbb')
    ...
    if clawdata.checkpt_style == 0:
        ...
        clawdata.checkpt_times = 3600.*np.arange(0.5,3.1,0.5)
    ...
    dtopo_data.dtopofiles = [[3, dtopodir + '/buried-random-mur13-deep.dtt3']]
    ...
    if 1:
        ...
        fg.min_level_check = amrdata.amr_levels_max  # only finest level
    ...
    if 1:
        ...
        fgout.nout = int(round(fgout.tend/dt_fgout)) + 1
        fgout.q_out_vars = [1,4]  # h,eta for shallow code
    ...
    if 1:
        ...
        fgout.point_style = 2       # will specify a 2d grid of points
        fgout.output_format = 'binary32'
        fgout.x1 = -126.5  # specify edges (fgout pts will be cell centers)
        fgout.x2 = -123.9
        fgout.y1 = 46.5
        fgout.y2 = 47.5
        fgout.nx = int(round((fgout.x2 - fgout.x1)/dx_fgout))
    ...
    for fgout in fgout_grids:
        #fgout.q_out_vars = [1,2,3,6]  # h,hu,hv,eta for bouss code
        fgout.q_out_vars = [1,6]  # h,eta for bouss code
