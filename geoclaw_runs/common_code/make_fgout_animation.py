...
outdir = os.path.join(os.getcwd(), '_output')
outdir = outdir.replace('/mmfs1/home/', '/gscratch/tsunami/') # on hyak
print('Looking for fgout data in \n    ',outdir)
...
if __name__ == '__main__':
    ...
    plotdir = plotdir.replace('/mmfs1/home/', '/gscratch/tsunami/') # on hyak
    #plotdir = os.getcwd()
    print('Will put animation in \n    ',plotdir)
