...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        ## ADJUST:
        clawdata.num_output_times = 4    #output every 5 minutes
    ...
    if amrdata.amr_levels_max == 4: #For 15" run around region of interest
    ...
    if amrdata.amr_levels_max == 5: #For the 5" runs
