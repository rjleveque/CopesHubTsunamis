...
if '/mmfs1/home/'  in topodir:
    # on hyak:
    topodir = '/gscratch/tsunami/rjl/MLSJdF/topo'
#dtopodir = root_dir + '/dtopo/CSZ_groundmotions'
...
#------------------------------
    ...
    clawdata.restart_file = 'fort.chk00151'  # File to use for restart data
    ...
    if clawdata.checkpt_style == 0:
      ...
      clawdata.checkpt_times = list(arange(2,7,2)*3600.)
...
#-------------------
    ...
    topofiles.append([3, os.path.join(topodir, 'etopo1_-163_-122_38_63.asc')])
    topofiles.append([3, os.path.join(topodir, 'SJdF_2sec_center.asc')])
    topofiles.append([3, os.path.join(topodir, 'PT_2sec_center.asc')])
    topofiles.append([3, os.path.join(topodir, 'PS_2sec_center.asc')])
    topofiles.append([3, os.path.join(topodir, 'DiscoveryBay_1_3s_center.asc')])
    ...
    # dtopo file set in run_geoclaw_dtopos.py
    #dtopotype  = 3
    #dtopofiles.append([dtopotype, os.path.join(dtopodir,dtopo_name)])
    rundata.dtopo_data.dt_max_dtopo = 10.
