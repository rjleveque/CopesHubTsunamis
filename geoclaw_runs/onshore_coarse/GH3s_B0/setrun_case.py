...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        ## ADJUST:
        clawdata.num_output_times = 0    # no frame output, only B0
        clawdata.tfinal = 1.  # for B0
    ...
    #topofiles.append([3, topo_dir + '/etopo22_1min_-163_-122_38_63.asc'])
    ...
    if 1:
        ...
        flagregion.minlevel = 6 #4  # 6 for B0
        flagregion.maxlevel = 6
        flagregion.t1 = tstart_finestgrid
        flagregion.t2 = 1e9
        flagregion.spatial_region_type = 1  # Rectangle
