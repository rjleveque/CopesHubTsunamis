...
def get_debris_path_t(t, debris_paths, dbnos):
    """
    Extract debris path [t,x,y,u,v] from debris_paths at this t.
    Should interpolate?
    """
    debris_path_t = {}
    for dbno in dbnos:
        ...
        if j > -1:
            ...
            #ud[dbno] = db[j,3]
            #vd[dbno] = db[j,4]
            debris_path_t[dbno] = db[j]
        else:
            debris_path_t[dbno] = 5*[nan]
    return debris_path_t
