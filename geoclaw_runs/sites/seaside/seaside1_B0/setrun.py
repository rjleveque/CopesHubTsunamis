...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        ## ADJUST:
        clawdata.num_output_times = 0 # to make B0
        clawdata.tfinal = 10. # to make B0
    ...
    #dtopo_data.dtopofiles = [[3, dtopofile]] # no dtopo to make orig B0
