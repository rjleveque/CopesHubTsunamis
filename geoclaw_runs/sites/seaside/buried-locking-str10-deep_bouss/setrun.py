...
use_bouss_version = True   # True ==> requires code compiled with PETSc etc.
...
#------------------------------
    ...
    clawdata.restart_file = 'fort.chkaaaaa'
    ...
    if clawdata.checkpt_style == 0:
        ...
        clawdata.checkpt_times = 3600.*np.arange(0.75,1.6,0.25)
