...
location = 'Seaside' # need to change module names below for other locations

sys.path.insert(0, os.path.abspath('..'))
import plot_gauges_seaside as plot_gauges
import process_fgmax_seaside as process_fgmax
import make_fgout_animation_seaside as make_fgout_animation
