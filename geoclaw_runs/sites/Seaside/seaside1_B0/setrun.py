...
#------------------------------
    ...
    #Next 2 statements commented out for no dtopo run
    ...
    if 1: 
        #Do the gauges this run as well to get gauge B0, especially since Randy 
        #may have started the quake at time 0,....
    ...
    if 1:  # Use a 1/3" fgmax grid like our Seaside project
        ...
        fg.dx = dx_fine
        fg.dy = dx_fine
        fg.tstart_max = 0.         # SHORT TEST, needed to make B0
